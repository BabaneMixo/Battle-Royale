...
public class Player {
    ...
    public static void welcome() throws InterruptedException {
        ...
        System.out.println(" -------------------------------------------------");
        Thread.sleep(500);
        System.out.println(" - 1 Sniper     -       50         -       10    -");
        Thread.sleep(500);
        System.out.println(" -------------------------------------------------");
        Thread.sleep(500);
        System.out.println(" - 2 AK-47      -       40         -       20    -");
        Thread.sleep(500);
        System.out.println(" -------------------------------------------------");
        Thread.sleep(500);
        System.out.println(" - 3 Steyr AUG  -       30         -       30    -");
        Thread.sleep(500);
        System.out.println(" -------------------------------------------------");
        Thread.sleep(500);
        System.out.println(" - 4 M4 carbine -       20          -        40    -");
        Thread.sleep(500);
        System.out.println(" -------------------------------------------------");
        Thread.sleep(500);
        System.out.println(" - 5 Pistol     -       10          -        50    -");
        Thread.sleep(500);
        System.out.println(" -------------------------------------------------");
        System.out.println(" -------------------------------------------------\n");
